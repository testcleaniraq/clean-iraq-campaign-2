  ...
  return (
    <main className="min-h-screen pt-27 box-border	scroll-smooth	overflow-x-hidden	">
      <section id='Home' className={` 2xl:h-[30rem] xl:h-[30rem] lg:h-[30rem] md:h-[36rem]  flex flex-col justify-center items-center relative   w-[98%] md:w-[90%] mx-auto mt-20 rounded-3xl mb-[9rem]   `}>
        <div className='bg-[#b2b2b2] h-full w-full flex flex-col justify-center items-center mx-auto rounded-3xl'>
          <h1 className='text-[4rem] text-white'>مدونة سفراء النظافة</h1>
          <p className='text-[2rem] text-white'>مدونة تحتوي على اخر اخبار الحملة وقصص نجاحهم ومحتوى تعليمي</p>
        </div>
